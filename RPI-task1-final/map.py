        ...
        if direction == 'n':
            if (row+9)>37:
                if (row+8)>37:
                    ...
                    return (row+7, col, 's')
                self.grid[row+8][col] = 4
                return (row+8, col, 's')
            self.grid[row+9][col] = 4
            return (row+9, col, 's')
        elif direction == 'e':
            if (col+9)>37:
                if (col+8)>37:
                    ...
                    return (row, col+7, 'w')
                self.grid[row][col+8] = 3
                return (row, col+8, 'w')
            self.grid[row][col+9] = 3
            return (row, col+9, 'w')
        elif direction == 's':
            if (row-9)<3:
                if (row-8)<3:
                    ...
                    return (row-7, col, 'n')
                self.grid[row-8][col] = 2
                return (row-8, col, 'n')
            self.grid[row-9][col] = 2
            return (row-9, col, 'n')
        elif direction == 'w':
            if (col-9)<3:
                if (col-8)<3:
                    ...
                    return (row, col-7, "e")
                self.grid[row][col-8] = 1
                return (row, col-8, "e")
            self.grid[row][col-9] = 1
            return (row, col-9, "e")
